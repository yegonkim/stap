...
do
    ...
    do
        ...
        # python run_experiment_al_flexible.py task=$EQ seed=$SEED wandb.project=${EQ}_9_27 initial_datasize=32 batch_acquire=8 num_acquire=10 initial_selection_method=variance post_selection_method=all
        python run_experiment_al_flexible.py task=$EQ seed=$SEED wandb.project=${EQ}_9_27 initial_datasize=32 batch_acquire=8 num_acquire=10 initial_selection_method=variance post_selection_method=flexible_max
