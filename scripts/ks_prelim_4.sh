...
do
    for EQ in KS
    do
        python run_experiment_al_flexible.py task=$EQ seed=$SEED nt=14 wandb.project=${EQ}_9_26 initial_datasize=128 batch_acquire=8 num_acquire=10 initial_selection_method=random post_selection_method=all cheat=True
