...
do
    ...
    do
        ...
        do
            ...
            # python run_experiment_al.py task=$EQ selection_method=lcmd ensemble_size=2 seed=$SEED initial_datasize=$SIZE batch_acquire=32
            python run_experiment_al.py task=$EQ selection_method=lcmd_shared ensemble_size=2 seed=$SEED initial_datasize=$SIZE batch_acquire=32
        done
    done
done
